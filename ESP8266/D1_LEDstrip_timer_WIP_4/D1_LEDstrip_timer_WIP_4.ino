...
Adafruit_MQTT_Publish tvruntime = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/tvruntime");


// Setup a feed cfor subscribing to changes.
Adafruit_MQTT_Subscribe timeleft= Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/timeleft");
...
long run_time = millis()/1000;

 Adafruit_MQTT_Subscribe *subscription;
  while ((subscription = mqtt.readSubscription(1000))) {
    if (subscription == &timeleft) {
      Serial.print(F("Got: "));
      Serial.println((char *)timeleft.lastread);
