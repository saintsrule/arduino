//  This is adapted from PI_yoghurt_working_WIP6
// Read POT input on AIN and send via MQTT.
// Designed for D1 board
...
// COMMENTED OUT THIS SECTION - NOT SUBSCRIBING TO INPUT FEED
