...
//------------------------------------------------------------------------------------
  ...
  #define       BUTTON    D3        // Connectivity ReInitiate Button
//------------------------------------------------------------------------------------
// BUTTON Variables
//------------------------------------------------------------------------------------
  int           ButtonState;
...
Adafruit_MQTT_Publish switch_state = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/switch");


// Setup a feed called 'onoff' for subscribing to changes.
Adafruit_MQTT_Subscribe onoffbutton = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/onoff");
Adafruit_MQTT_Subscribe pin = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/pin");
...
if (! switch_state.publish(reading)) {
    Serial.println(F("switch publish Failed"));
  } else {
    Serial.println(F("switch publish OK!"));
  }
