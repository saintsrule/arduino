...
//  temperature = message2;   // MET get temperature direct from sensor now
...
// MET added temperature sensor
  sensors.requestTemperatures();
  temperature = sensors.getTempCByIndex(0);
  Serial.println (temperature);

// MET read potentiometer value 
  potValue = analogRead(A0);
  Serial.println (potValue);

  on_time=(potValue*cycle_time/1000)+1;
  ...
  switch (brewStage) {
    ...
    case 3:
      ...
      if (minutesCounter > mashTime) {
        ...
        terminal.flush();
        Blynk.email("terrific.tuckers@gmail.com", "MASH DONE", "The Mash is done, remove the mash bag now.");
    ...
    Serial.println("running case 6");
      ...
      if (minutesCounter > boilTime) {
        ...
        terminal.flush();
        Blynk.email("terrific.tuckers@gmail.com", "Boil finished", "Go add Ice");
    ...
    case 7:
      ...
      if (temperature <= (yeastPitchTemperature + 10)) {
        ...
        terminal.flush();
        Blynk.email("terrific.tuckers@gmail.com", "Wort ready", "You can now move the wort to the fermenter and pitch the yeast.");
    ...
    case 8:
      ...
      if ((fermentTimeprimary - days) <= 0) {
        ...
        terminal.flush();
        Blynk.email("terrific.tuckers@gmail.com", "Brew Ready", "The fermentation time is over, the brew is ready.");
        brewStage = 9;
      }
      break;
    case 9:
