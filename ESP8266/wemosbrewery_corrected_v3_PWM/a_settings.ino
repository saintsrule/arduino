...
int mashTemp = 18; // Temp in celcius  // Was 65
int boilTemp = 22; // Temp in celcius, set to max 97  // Miles reduced to 97 because boiling occurs at 98max
// int boilTemp = 99; // Temp in celcius, set to max 99
int mashTime = 1; // number of minutes you are going to mash
